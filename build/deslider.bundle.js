...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__node_modules_hammerjs_hammer_js__ = __webpack_require__(298);
...
class Deslider {
  ...
  addSwipe(){
    this.sliderManager = new __WEBPACK_IMPORTED_MODULE_0__node_modules_hammerjs_hammer_js___default.a.Manager(this.sliderEl);
    this.sensitivity = 25;
    this.sliderManager.add(new __WEBPACK_IMPORTED_MODULE_0__node_modules_hammerjs_hammer_js___default.a.Pan({threshold: 0, pointers: 0}));
